...
import { aadharPayEndpoint } from "./ApiFun";
    ...
    },
    {
      ...
      render: (text, record) => (
        <div className="flex justify-start items-center ">
          <NavLink to={"/common-settings/aadharPay-surcharge-setting/change"} state={{endpoint:aadharPayEndpoint.aadharpayfun,from:"Edit Aadhar Pay Surcharge",record,getEndpoint:aadharPayEndpoint.aadharpayfun}}>
            <p
              onClick={() => {
                // setOpenModal(true);
                // setOpenFrom("edit");
