...
import { UpidmtEndpoint } from "./ApiFun";
    ...
    },
    {
      ...
      render: (text, record) => (
        <div className="flex justify-start items-center ">
          <NavLink to={"/common-settings/aadharPay-surcharge-setting/change"} state={{endpoint:UpidmtEndpoint.upiDmtfun,from:"Edit Credit Card Surcharge",record,getEndpoint:UpidmtEndpoint.upiDmtfun}}>
            <p
              onClick={() => {
                // setOpenModal(true);
                // setOpenFrom("edit");
