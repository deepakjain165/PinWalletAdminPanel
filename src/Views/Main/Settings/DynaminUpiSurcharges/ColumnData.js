...
import { DynamicUpiEndpoint } from "./ApiFun";
    ...
    },
    {
      ...
      render: (text, record) => (
        <div className="flex justify-start items-center ">
          <NavLink
            to={"/common-settings/dynamicUpi-surcharge-setting/change"}
            state={{
              endpoint: DynamicUpiEndpoint.DynamicUpiSurchargeFun,
              from: "Edit Dynamic UPI Surcharge",
              record,
              getEndpoint: DynamicUpiEndpoint.DynamicUpiSurchargeFun,
            }}
          >
            <p
              onClick={() => {
