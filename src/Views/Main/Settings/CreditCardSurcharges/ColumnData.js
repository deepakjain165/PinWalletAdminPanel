...
import { creditEndpoint } from "./ApiFun";
    ...
    },
    {
      ...
      render: (text, record) => (
        <div className="flex justify-start items-center ">
          <NavLink to={"/common-settings/creditCard-surcharge-setting/change"} state={{endpoint:creditEndpoint.creditCardSurchargeFun,from:"Edit Credit Card Surcharge",record,getEndpoint:creditEndpoint.creditCardSurchargeFun}}>
            <p
              onClick={() => {
                // setOpenModal(true);
                // setOpenFrom("edit");
