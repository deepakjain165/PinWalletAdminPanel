...
const WalletPayout = () => {
  ...
  return (
    <>
      <CommonLayout
     PageName={"Wallet Payout Transactions"}
      setFields={setFields}
      fields={fields}
      ...
      />
      <PaginationComponent setNumberOfData={setNumberOfData} current={current} numberOfPAges={numberOfPAges} start={start} apiFunction={getAllWalletPayout} handlepageChange={handlepageChange} numberOfData={numberOfData}/>
